...
public class YourResponseadv extends JFrame implements MouseListener , ActionListener

{
	...
	YourResponseAB respoBgn;
	public YourResponseadv(Advance h)
	{
		super("Advance Level");
		respoBgn=new YourResponseAB();
