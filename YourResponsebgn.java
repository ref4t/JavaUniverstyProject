...
public class YourResponsebgn extends JFrame implements MouseListener , ActionListener

{
	...
	YourResponseBB respoBgn;
	public YourResponsebgn(beginners h)
	{
		super("Beginner's Level");
		respoBgn=new YourResponseBB();
	...
	title3 = new JLabel(respoBgn.getQues());
	...
	btn1 = new JButton(respoBgn.getAns1());
	...
	btn2 = new JButton(respoBgn.getAns2());
	...
	btn3 = new JButton(respoBgn.getAns3());
	...
	btn4 = new JButton(respoBgn.getAns4());
  ...
  if(e.getSource().equals(back))
	   {
	     ...
	     this.setVisible(false);
		  ...
		  if(respoBgn.getAns1().equals(respoBgn.getCans())){
		 ...
		 if(respoBgn.getAns2().equals(respoBgn.getCans())){
		 ...
		 if(respoBgn.getAns3().equals(respoBgn.getCans())){
		 ...
		 if(respoBgn.getAns4().equals(respoBgn.getCans())){
		 ...
		 respoBgn.setCount();
		title3.setText(respoBgn.getQues());
		btn1.setText(respoBgn.getAns1());
		btn2.setText(respoBgn.getAns2());
		btn3.setText(respoBgn.getAns3());
		btn4.setText(respoBgn.getAns4());
		btn1.setBackground(Color.GRAY);
		btn2.setBackground(Color.GRAY);
		btn3.setBackground(Color.GRAY);
		btn4.setBackground(Color.GRAY);
