...
import java.io.*;
import java.applet.*;
public class Songlyricsbgn extends JFrame implements MouseListener , ActionListener

{
	...
	public Songlyricsbgn(beginners h)
	{
		super("Beginner's Level");
		sly=new SongLyricsBB();
...
public void audioStart()
  {
  	String audioFile="Audio/b/bly"+sly.getAudioNumber()+".wav"; 
  	try{
       audioInputStream =
