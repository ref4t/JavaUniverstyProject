...
class PractiseGrammerAB{
	public static int numCount;
	String question,answer1,answer2,answer3,answer4,canswer;
	public PractiseGrammerAB(){
		numCount=1;
		wordSet();
	}
	 public void wordSet(){
	   String sql="select * from pgAdv where Number="+numCount;
	//   System.out.println("Entered in  wordSet: numCount: "+numCount);
	     try
		 {
			 Connection con=null;
		 Class.forName("org.sqlite.JDBC");
		 con = DriverManager.getConnection("jdbc:sqlite:database/MCQbgn.db");
