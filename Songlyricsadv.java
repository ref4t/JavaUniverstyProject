...
import java.io.*;
import java.applet.*;
public class Songlyricsadv extends JFrame implements MouseListener , ActionListener

{
    ...
    Clip clip;
	public Songlyricsadv(Advance h)
	{
		super("Advance Level");
		sly=new SongLyricsAB();
...
public void audioStart(){
  	String audioFile="Audio/a/bly"+sly.getAudioNumber()+".wav"; 
  	try{
       audioInputStream =
