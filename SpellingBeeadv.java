...
public class SpellingBeeadv extends JFrame implements MouseListener , ActionListener

{
	...
	public SpellingBeeadv(Advance h)
	{
		super("Advance Level");
		sbee=new SpellingBeeAB();
...
public void mouseReleased(MouseEvent me){}
 public void actionPerformed(ActionEvent e){
  ...
  {
  	String audioFile="Audio/a/aw"+sbee.getAudioNumber()+".wav"; 
  	try{
       audioInputStream =
