...
public class PractiseGrammerbgn extends JFrame implements MouseListener , ActionListener

{
	...
	PractiseGrammerBB pgBgn;
	public PractiseGrammerbgn(beginners h)
	{
		super("Beginner's Level");
		pgBgn=new PractiseGrammerBB();
