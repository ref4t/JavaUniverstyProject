...
public class beginners extends JFrame implements MouseListener , ActionListener

{
	...
	public void mouseReleased(MouseEvent me){}
 	...
 	{
		 /*begginers b=new beginners(this);
		 begginers b=new beginners(this);
	  ...
	  Songlyricsbgn slb=new Songlyricsbgn(this);
	  slb.setVisible(true);
	  this.setVisible(false);
	  
       }
      else if(ae.getSource().equals(btn1)){
		  PractiseGrammerbgn pgb= new PractiseGrammerbgn(this);
		  pgb.setVisible(true);
		  this.setVisible(false);
	  }	
      else if(ae.getSource().equals(btn2)){
	YourResponsebgn respobgn= new YourResponsebgn(this);
	respobgn.setVisible(true);
	this.setVisible(false);
}	  
    else if(ae.getSource().equals(btn3)){
	SpellingBeebgn respobgn= new SpellingBeebgn(this);
	respobgn.setVisible(true);
	this.setVisible(false);
}    
      else if(ae.getSource().equals(btn5))
	  {
		    PronounceTest2 p=new PronounceTest2(this,1);
		   p.setVisible(true);
		   this.setVisible(false);
	  }
