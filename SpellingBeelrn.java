...
public class SpellingBeelrn extends JFrame implements MouseListener , ActionListener

{
	...
	public SpellingBeelrn(Learners h)
	{
		super("Learner's Level");
		sbee=new SpellingBeeLB();
...
public void mouseReleased(MouseEvent me){}
 public void actionPerformed(ActionEvent e){
  ...
  {
  	String audioFile="Audio/l/aw"+sbee.getAudioNumber()+".wav"; 
  	try{
       audioInputStream =
