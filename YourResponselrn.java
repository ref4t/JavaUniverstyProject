...
public class YourResponselrn extends JFrame implements MouseListener , ActionListener

{
	...
	YourResponseLB respoBgn;
	public YourResponselrn(Learners h)
	{
		super("Learner's Level");
		respoBgn=new YourResponseLB();
