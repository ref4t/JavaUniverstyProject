...
public class Advance extends JFrame implements MouseListener , ActionListener

{
	...
	public void mouseReleased(MouseEvent me){}
	 ...
	 public void actionPerformed(ActionEvent ae)
 	{
	   ...
	   {
	   	 SpellingBeeadv sba= new SpellingBeeadv(this);
	     sba.setVisible(true);
	     this.setVisible(false);
		 
	   }
	   else if(ae.getSource().equals(btn1)){
		   PractiseGrammeradv pga=new PractiseGrammeradv(this);
		   pga.setVisible(true);
		   this.setVisible(false);
	   }
	   else if(ae.getSource().equals(btn2)){
		   YourResponseadv yra=new YourResponseadv(this);
		   yra.setVisible(true);
		   this.setVisible(false);
	   }
	  else if(ae.getSource().equals(btn4)){
		   Songlyricsadv sla=new Songlyricsadv(this);
		   sla.setVisible(true);
		   this.setVisible(false);
	   }
	   else if(ae.getSource().equals(btn5)){
		   PronounceTest p=new PronounceTest(this,1);
		   p.setVisible(true);
		   this.setVisible(false);
	   }
	} 
